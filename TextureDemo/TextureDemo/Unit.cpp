...
Unit::Unit(int type, 
	...
	: GameObject (entityPosition,entityTexture,entityNumElements), type(type), health(health), playerControlled(playerControlled), movementSpeed(movementSpeed), graph(graph)
{
	scale = unitScale;
	health = 100;
